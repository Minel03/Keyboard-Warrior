...
var dialogues = [
	"Finally, with one last surge of energy, Ethan conjures a spell of unprecedented power. The golem roars in defiance, but it is no match for Ethan's resolve. In a blinding explosion of light, the golem disintegrates, its dark essence dissipating into the ether.",
]
